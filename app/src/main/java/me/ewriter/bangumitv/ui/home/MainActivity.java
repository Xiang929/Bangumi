...
import me.ewriter.bangumitv.ui.index.IndexFragment;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener, HomeContract.View, View.OnClickListener {
    ...
    protected void initView() {
        ...
        mSwitch = (SwitchCompat) mNavigationView.getMenu().getItem(5).getActionView();
        ...
        mDrawLayout.post(new Runnable() {
            ...
            public void run() {
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_index:
                        mPresenter.updateSelectedFragment(mFragmentManager, IndexFragment.class.getName());
                        mPresenter.updateCurrentTag(IndexFragment.class.getName());
                        break;
