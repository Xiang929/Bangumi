package me.home.bangumi.widget.headerfooter;
...
public class RecyclerViewStateUtils {
    ...
    public static LoadingFooter.State getFooterViewState(RecyclerView recyclerView) {
        ...
        RecyclerView.Adapter outerAdapter = recyclerView.getAdapter();
        if (outerAdapter != null && outerAdapter instanceof HeaderAndFooterAdapter) {
            if (((HeaderAndFooterAdapter) outerAdapter).getFooterViewsCount() > 0) {
                LoadingFooter footerView = (LoadingFooter) ((HeaderAndFooterAdapter) outerAdapter).getFooterView();
